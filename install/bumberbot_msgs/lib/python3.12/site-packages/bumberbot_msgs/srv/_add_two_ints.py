...
class Metaclass_AddTwoInts_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('bumberbot_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_AddTwoInts_Event(type):
    """Metaclass of message 'AddTwoInts_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__add_two_ints__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__add_two_ints__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__add_two_ints__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__add_two_ints__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__add_two_ints__event
...
class AddTwoInts_Event(metaclass=Metaclass_AddTwoInts_Event):
    """Message class 'AddTwoInts_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<bumberbot_msgs/AddTwoInts_Request, 1>',
        'response': 'sequence<bumberbot_msgs/AddTwoInts_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['bumberbot_msgs', 'srv'], 'AddTwoInts_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['bumberbot_msgs', 'srv'], 'AddTwoInts_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from bumberbot_msgs.srv import AddTwoInts_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, AddTwoInts_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'AddTwoInts_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from bumberbot_msgs.srv import AddTwoInts_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, AddTwoInts_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'AddTwoInts_Response'"
...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from bumberbot_msgs.srv import _add_two_ints
            ...
            if _add_two_ints.Metaclass_AddTwoInts_Event._TYPE_SUPPORT is None:
                _add_two_ints.Metaclass_AddTwoInts_Event.__import_type_support__()


class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from bumberbot_msgs.srv._add_two_ints import AddTwoInts_Request as Request
    from bumberbot_msgs.srv._add_two_ints import AddTwoInts_Response as Response
    from bumberbot_msgs.srv._add_two_ints import AddTwoInts_Event as Event
