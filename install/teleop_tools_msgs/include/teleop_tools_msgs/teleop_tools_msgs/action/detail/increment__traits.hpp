...
// IWYU pragma: private, include "teleop_tools_msgs/action/increment.hpp"
...
inline void to_flow_style_yaml(
  const Increment_SendGoal_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const Increment_SendGoal_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use teleop_tools_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const teleop_tools_msgs::action::Increment_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  teleop_tools_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use teleop_tools_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const teleop_tools_msgs::action::Increment_SendGoal_Event & msg)
{
  return teleop_tools_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<teleop_tools_msgs::action::Increment_SendGoal_Event>()
{
  return "teleop_tools_msgs::action::Increment_SendGoal_Event";
}

template<>
inline const char * name<teleop_tools_msgs::action::Increment_SendGoal_Event>()
{
  return "teleop_tools_msgs/action/Increment_SendGoal_Event";
}

template<>
struct has_fixed_size<teleop_tools_msgs::action::Increment_SendGoal_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<teleop_tools_msgs::action::Increment_SendGoal_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<teleop_tools_msgs::action::Increment_SendGoal_Request>::value && has_bounded_size<teleop_tools_msgs::action::Increment_SendGoal_Response>::value> {};

template<>
struct is_message<teleop_tools_msgs::action::Increment_SendGoal_Event>
  : std::true_type {};
...
inline void to_flow_style_yaml(
  const Increment_GetResult_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const Increment_GetResult_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use teleop_tools_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const teleop_tools_msgs::action::Increment_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  teleop_tools_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use teleop_tools_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const teleop_tools_msgs::action::Increment_GetResult_Event & msg)
{
  return teleop_tools_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<teleop_tools_msgs::action::Increment_GetResult_Event>()
{
  return "teleop_tools_msgs::action::Increment_GetResult_Event";
}

template<>
inline const char * name<teleop_tools_msgs::action::Increment_GetResult_Event>()
{
  return "teleop_tools_msgs/action/Increment_GetResult_Event";
}

template<>
struct has_fixed_size<teleop_tools_msgs::action::Increment_GetResult_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<teleop_tools_msgs::action::Increment_GetResult_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<teleop_tools_msgs::action::Increment_GetResult_Request>::value && has_bounded_size<teleop_tools_msgs::action::Increment_GetResult_Response>::value> {};

template<>
struct is_message<teleop_tools_msgs::action::Increment_GetResult_Event>
  : std::true_type {};
